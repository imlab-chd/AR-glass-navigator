...
public class XunFeiManager : MonoBehaviour
{
    ...
    private const string APPID = "5497c25e";
    /// <summary>改成你自己的APISecret</summary>
    private const string APISecret = "NDI2MzM4M2Q3YmIzNGFjZWQ1MWU3NTQ0";
    /// <summary>改成你自己的APIKey</summary>
    private const string APIKey = "b491be3f09298175239983b9d204707d";
